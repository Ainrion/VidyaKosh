...
const navigation = {
  admin: [
    ...
    { name: 'Quiz Submissions', href: '/admin/quiz-submissions', icon: FileText, description: 'View and manage quiz submissions' },
  ...
  teacher: [
    ...
    { name: 'Quiz Builder', href: '/quiz-builder', icon: Target },
    { name: 'Quiz Submissions', href: '/admin/quiz-submissions', icon: FileText, description: 'View student quiz submissions' },
    { name: 'Exams', href: '/exams', icon: ClipboardList },
    { name: 'Assignments', href: '/assignments', icon: PenTool },
    { name: 'Calendar', href: '/calendar', icon: Calendar },
